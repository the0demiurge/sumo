...
#include "MSPModel_SocialForce.h"
...
void MSPModel_SocialForce::DEBUG_PRINT(const Obstacles& obs) {
...
const double MSPModel_SocialForce::DIST_FAR_AWAY(10000);
const double MSPModel_SocialForce::DIST_BEHIND(1000);
const double MSPModel_SocialForce::DIST_OVERLAP(-1);

// ===========================================================================
// static members
// ===========================================================================

MSPModel_SocialForce::WalkingAreaPaths MSPModel_SocialForce::myWalkingAreaPaths;
std::map<const MSEdge*, std::vector<const MSLane*> >  MSPModel_SocialForce::myWalkingAreaFoes;
MSPModel_SocialForce::MinNextLengths MSPModel_SocialForce::myMinNextLengths;
MSPModel_SocialForce::Pedestrians MSPModel_SocialForce::noPedestrians;

// model parameters (static to simplify access from class PState
double MSPModel_SocialForce::stripeWidth;
double MSPModel_SocialForce::dawdling;
double MSPModel_SocialForce::minGapToVehicle;
SUMOTime MSPModel_SocialForce::jamTime;
SUMOTime MSPModel_SocialForce::jamTimeCrossing;
SUMOTime MSPModel_SocialForce::jamTimeNarrow;
const double MSPModel_SocialForce::LOOKAHEAD_SAMEDIR(4.0); // seconds
const double MSPModel_SocialForce::LOOKAHEAD_ONCOMING(10.0); // seconds
const double MSPModel_SocialForce::LOOKAROUND_VEHICLES(60.0); // meters
const double MSPModel_SocialForce::LATERAL_PENALTY(-1.); // meters
const double MSPModel_SocialForce::OBSTRUCTED_PENALTY(-300000.); // meters
const double MSPModel_SocialForce::INAPPROPRIATE_PENALTY(-20000.); // meters
const double MSPModel_SocialForce::ONCOMING_CONFLICT_PENALTY(-1000.); // meters
const double MSPModel_SocialForce::OBSTRUCTION_THRESHOLD(MSPModel_SocialForce::OBSTRUCTED_PENALTY * 0.5); // despite obstruction, additional utility may have been added
const double MSPModel_SocialForce::SQUEEZE(0.7);
double MSPModel_SocialForce::RESERVE_FOR_ONCOMING_FACTOR(0.0);
double MSPModel_SocialForce::RESERVE_FOR_ONCOMING_FACTOR_JUNCTIONS(0.34);
const double MSPModel_SocialForce::MAX_WAIT_TOLERANCE(120.); // seconds
const double MSPModel_SocialForce::LATERAL_SPEED_FACTOR(0.4);
const double MSPModel_SocialForce::MIN_STARTUP_DIST(0.4); // meters


// ===========================================================================
// MSPModel_SocialForce method definitions
// ===========================================================================

MSPModel_SocialForce::MSPModel_SocialForce(const OptionsCont& oc, MSNet* net) :
...
MSPModel_SocialForce::~MSPModel_SocialForce() {
    clearState();
...
void
MSPModel_SocialForce::clearState() {
    myActiveLanes.clear();
    myNumActivePedestrians = 0;
    myAmActive = false;
}
...
MSPModel_SocialForce::add(MSTransportable* transportable, MSStageMoving* stage, SUMOTime) {
...
MSTransportableStateAdapter*
MSPModel_SocialForce::loadState(MSTransportable* transportable, MSStageMoving* stage, std::istringstream& in) {
    MSPerson* person = static_cast<MSPerson*>(transportable);
    MSNet* net = MSNet::getInstance();
    if (!myAmActive) {
...
void
MSPModel_SocialForce::remove(MSTransportableStateAdapter* state) {
...
bool
MSPModel_SocialForce::blockedAtDist(const MSLane* lane, double vehSide, double vehWidth,
...
bool
MSPModel_SocialForce::hasPedestrians(const MSLane* lane) {
    return getPedestrians(lane).size() > 0;
}


bool
MSPModel_SocialForce::usingInternalLanes() {
    return usingInternalLanesStatic();
}

bool
MSPModel_SocialForce::usingInternalLanesStatic() {
    return MSGlobals::gUsingInternalLanes && MSNet::getInstance()->hasInternalLinks() && MSNet::getInstance()->hasPedestrianNetwork();
}

PersonDist
MSPModel_SocialForce::nextBlocking(const MSLane* lane, double minPos, double minRight, double maxLeft, double stopTime, bool bidi) {
...
MSPModel_SocialForce::Pedestrians&
MSPModel_SocialForce::getPedestrians(const MSLane* lane) {
...
int
MSPModel_SocialForce::numStripes(const MSLane* lane) {
    return MAX2(1, (int)floor(lane->getWidth() / stripeWidth));
}

int
MSPModel_SocialForce::connectedDirection(const MSLane* from, const MSLane* to) {
...
void
MSPModel_SocialForce::initWalkingAreaPaths(const MSNet*) {
...
const MSPModel_SocialForce::WalkingAreaPath*
MSPModel_SocialForce::getArbitraryPath(const MSEdge* walkingArea) {
...
const MSPModel_SocialForce::WalkingAreaPath*
MSPModel_SocialForce::guessPath(const MSEdge* walkingArea, const MSEdge* before, const MSEdge* after) {
    assert(walkingArea->isWalkingArea());
...
const MSPModel_SocialForce::WalkingAreaPath*
MSPModel_SocialForce::getWalkingAreaPath(const MSEdge* walkingArea, const MSLane* before, const MSLane* after) {
    assert(walkingArea->isWalkingArea());
...
MSPModel_SocialForce::NextLaneInfo
MSPModel_SocialForce::getNextLane(const PState& ped, const MSLane* currentLane, const MSLane* prevLane) {
...
const MSLane*
MSPModel_SocialForce::getNextWalkingArea(const MSLane* currentLane, const int dir, const MSLink*& link) {
    if (dir == FORWARD) {
...
MSPModel_SocialForce::Obstacles
MSPModel_SocialForce::getNeighboringObstacles(const Pedestrians& pedestrians, int egoIndex, int stripes) {
...
int
MSPModel_SocialForce::getStripeOffset(int origStripes, int destStripes, bool addRemainder) {
...
const MSPModel_SocialForce::Obstacles&
MSPModel_SocialForce::getNextLaneObstacles(NextLanesObstacles& nextLanesObs, const
...
void
MSPModel_SocialForce::transformToCurrentLanePositions(Obstacles& obs, int currentDir, int nextDir, double currentLength, double nextLength) {
...
void
MSPModel_SocialForce::addCloserObstacle(Obstacles& obs, double x, int stripe, int numStripes, const std::string& id, double width, int dir, ObstacleType type) {
...
void
MSPModel_SocialForce::moveInDirection(SUMOTime currentTime, std::set<MSPerson*>& changedLane, int dir) {
...
bool
MSPModel_SocialForce::addVehicleFoe(const MSVehicle* veh, const MSLane* walkingarea, const Position& relPos, double xWidth, double yWidth, double lateral_offset,
...
void
MSPModel_SocialForce::arriveAndAdvance(Pedestrians& pedestrians, SUMOTime currentTime, std::set<MSPerson*>& changedLane, int dir) {
...
void
MSPModel_SocialForce::moveInDirectionOnLane(Pedestrians& pedestrians, const MSLane* lane, SUMOTime currentTime, std::set<MSPerson*>& changedLane, int dir) {
...
bool
MSPModel_SocialForce::addCrossingVehs(const MSLane* crossing, int stripes, double lateral_offset, int dir, Obstacles& obs, bool prio) {
    bool hasCrossingVehObs = false;
...
MSPModel_SocialForce::Obstacles
MSPModel_SocialForce::getVehicleObstacles(const MSLane* lane, int dir, PState* ped) {
    const int stripes = numStripes(lane);
...
// ===========================================================================
// MSPModel_SocialForce::Obstacle method definitions
// ===========================================================================
MSPModel_SocialForce::Obstacle::Obstacle(int dir, double dist) :
...
MSPModel_SocialForce::Obstacle::Obstacle(const PState& ped) :
    xFwd(ped.getMaxX()),
    xBack(ped.getMinX()),
...
// ===========================================================================
// MSPModel_SocialForce::PState method definitions
// ===========================================================================
MSPModel_SocialForce::PState::PState(MSPerson* person, MSStageMoving* stage, const MSLane* lane):
    myPerson(person),
    myStage(stage),
    myLane(lane),
...
MSPModel_SocialForce::PState::PState():
    myPerson(nullptr),
    myStage(nullptr),
    myLane(nullptr),
    myRelX(0),
...
MSPModel_SocialForce::PState::PState(MSPerson* person, MSStageMoving* stage, std::istringstream* in):
    myPerson(person),
    myStage(stage),
    myLane(nullptr),
    myWalkingAreaPath(nullptr),
...
void
MSPModel_SocialForce::PState::saveState(std::ostringstream& out) {
...
double
MSPModel_SocialForce::PState::getMinX(const bool includeMinGap) const {
...
double
MSPModel_SocialForce::PState::getMaxX(const bool includeMinGap) const {
    // @todo speed should have an influence here because faster persons need more space
    if (myDir == FORWARD) {
        return myRelX + (includeMinGap ? getMinGap() : 0.);
    }
...
double
MSPModel_SocialForce::PState::getLength() const {
    return myPerson->getVehicleType().getLength();
}


double
MSPModel_SocialForce::PState::getMinGap() const {
    return myPerson->getVehicleType().getMinGap();
}


int
MSPModel_SocialForce::PState::stripe(double relY) {
    return (int)floor(relY / stripeWidth + 0.5);
}


int
MSPModel_SocialForce::PState::otherStripe(double relY) const {
...
int
MSPModel_SocialForce::PState::stripe() const {
    return MIN2(MAX2(0, stripe(myRelY)), numStripes(myLane) - 1);
}


int
MSPModel_SocialForce::PState::otherStripe() const {
    return MIN2(MAX2(0, otherStripe(myRelY)), numStripes(myLane) - 1);
}


double
MSPModel_SocialForce::PState::distToLaneEnd() const {
...
bool
MSPModel_SocialForce::PState::moveToNextLane(SUMOTime currentTime) {
...
void
MSPModel_SocialForce::PState::walk(const Obstacles& obs, SUMOTime currentTime) {
...
double
MSPModel_SocialForce::PState::getImpatience(SUMOTime now) const {
...
double
MSPModel_SocialForce::PState::getEdgePos(const MSStageMoving&, SUMOTime) const {
    return myRelX;
}


int
MSPModel_SocialForce::PState::getDirection(const MSStageMoving&, SUMOTime) const {
    return myDir;
}


Position
MSPModel_SocialForce::PState::getPosition(const MSStageMoving& stage, SUMOTime) const {
...
double
MSPModel_SocialForce::PState::getAngle(const MSStageMoving&, SUMOTime) const {
...
SUMOTime
MSPModel_SocialForce::PState::getWaitingTime(const MSStageMoving&, SUMOTime) const {
    return myWaitingTime;
}


double
MSPModel_SocialForce::PState::getSpeed(const MSStageMoving&) const {
    return mySpeed;
}


const MSEdge*
MSPModel_SocialForce::PState::getNextEdge(const MSStageMoving&) const {
    return myNLI.lane == nullptr ? nullptr : &myNLI.lane->getEdge();
}


void
MSPModel_SocialForce::PState::moveTo(MSPerson* p, MSLane* lane, double lanePos, double lanePosLat, SUMOTime t) {
...
void
MSPModel_SocialForce::PState::moveToXY(MSPerson* p, Position pos, MSLane* lane, double lanePos,
                                    double lanePosLat, double angle, int routeOffset,
                                    const ConstMSEdgeVector& edges, SUMOTime t) {
    MSPModel_SocialForce* pm = dynamic_cast<MSPModel_SocialForce*>(MSNet::getInstance()->getPersonControl().getMovementModel());
    assert(p == myPerson);
    assert(pm != nullptr);
...
bool
MSPModel_SocialForce::PState::isJammed() const {
    return myAmJammed;
}

const MSLane*
MSPModel_SocialForce::PState::getLane() const {
    return myLane;
}

double
MSPModel_SocialForce::PState::distanceTo(const Obstacle& obs, const bool includeMinGap) const {
    // check for overlap
...
void
MSPModel_SocialForce::PState::mergeObstacles(Obstacles& into, const Obstacles& obs2) {
...
void
MSPModel_SocialForce::PState::mergeObstacles(Obstacles& into, const Obstacles& obs2, int dir, int offset) {
    for (int i = 0; i < (int)into.size(); ++i) {
        int i2 = i + offset;
...
bool
MSPModel_SocialForce::PState::ignoreRed(const MSLink* link) const {
    if (link->haveRed()) {
...
const std::string&
MSPModel_SocialForce::PState::getID() const {
    return myPerson->getID();
}

double
MSPModel_SocialForce::PState::getWidth() const {
    return myPerson->getVehicleType().getWidth();
}


bool
MSPModel_SocialForce::PState::isRemoteControlled() const {
    return myPerson->hasInfluencer() && myPerson->getInfluencer().isRemoteControlled();
}

// ===========================================================================
// MSPModel_SocialForce::PStateVehicle method definitions
// ===========================================================================

MSPModel_SocialForce::PStateVehicle::PStateVehicle(const MSVehicle* veh, const MSLane* walkingarea, double relX, double relY, double xWidth, double yWidth):
...
const std::string&
MSPModel_SocialForce::PStateVehicle::getID() const {
    return myVehicle->getID();
}

double
MSPModel_SocialForce::PStateVehicle::getWidth() const {
    return myYWidth;
}

double
MSPModel_SocialForce::PStateVehicle::getMinX(const bool /*includeMinGap*/) const {
    return myRelX - myXWidth / 2 - SAFETY_GAP ;
}

double
MSPModel_SocialForce::PStateVehicle::getMaxX(const bool /*includeMinGap*/) const {
    return myRelX + myXWidth / 2 + SAFETY_GAP;
}

// ===========================================================================
// MSPModel_SocialForce::MovePedestrians method definitions
// ===========================================================================

SUMOTime
MSPModel_SocialForce::MovePedestrians::execute(SUMOTime currentTime) {
